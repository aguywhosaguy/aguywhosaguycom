...
const List = () => {
	...
	const filteredLevels = () => {
		...
		return levels()?.filter((level) => level.name.includes(search()))
	}
	...
	return (
		<div class="flex h-[calc(100vh-6rem)]">
				...
				<ErrorBoundary fallback={<div class="text-base-content ml-5">An error occured! Please <a href="/">bully me online</a> until I fix it.</div>}>
					<Suspense fallback={<div class="text-base-content ml-5">Loading..</div>}>
						<div class="overflow-y-auto h-full">
							...
							/>
							<div 
							class="m-5 justify-start bg-base-200 hover:bg-base-300 text-base-content h-15 flex items-center text-sm lg:text-2xl md:text-xl p-5 border-1 border-base-content" 
							on:click={() => setLevel(undefined)}
							>
								<HiOutlineInformationCircle class="mr-5 flex-shrink-0" />
								<h1 class="truncate">Info</h1>
							</div>
			...
			<div class="w-4/5 mt-5 border-1 border-base-content">
