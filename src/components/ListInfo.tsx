const ListInfo = () => {
	return (
		<div class="w-4/5 h-full m-5 ">
			...
			<h6 class="textarea-xs pl-0.5 pb-5">
				a.k.a the Upside-Down UFO Platformer Challenge List
			</h6>
			<h2 class="lg:text-4xl md:text-2xl text-lg">
			...
			<ol class="p-5 space-y-2 lg:text-xl md:text-lg text-md mb-3">
				...
				<li>7. Spam levels must not be repetitive or go over <strong>12</strong> CPS.</li>
			</ol>
			<a href='https://discord.gg/aeQQgU7aMr' class="w-12">
				<svg 
					stroke-width="0" 
					xmlns="http://www.w3.org/2000/svg" 
					viewBox="0 0 16 16"
					class="fill-base-content cursor-pointer w-12 h-12"
				>
